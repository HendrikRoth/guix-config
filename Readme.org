...
#+begin_src emacs-lisp :mkdirp yes :tangle ~/.config/nyxt/init.lisp
  ...
  ;; search engines
  (make-search-engine "google" "https://www.google.com/search?q=~a" "https://www.google.com/")
  (make-search-engine "wikipedia" "https://de.wikipedia.org/search?q=~a" "https://de.wikipedia.org/")
  (make-search-engine "duckduckgo" "https://duckduckgo.com?q=~a" "https://duckduckgo.com/")
  (make-search-engine "leo" "https://dict.leo.org/englisch-deutsch/~a" "https://dict.leo.org/")
  (make-search-engine "leo-reverse" "https://dict.leo.org/englisch-deutsch/~a?side=left" "https://dict.leo.org/")
#+end_src
* Scripts
** Dmenu
