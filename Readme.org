...
#+begin_src emacs-lisp :tangle ~/.emacs.d/init.el
  ...
  (setq org-capture-templates
      '(("S" "Specification sheet" entry (file get-org-target) "* THIS IS A TEMPLATE")
        ("s" "Sprint" entry (file get-org-target) "* Sprint")
        ("o" "Shopping" entry (file "~/Notes/Shopping.org") "* :BUY: %?\n%U" :empty-lines 1)))
#+end_src
